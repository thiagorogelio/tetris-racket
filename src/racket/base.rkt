...
;; Template de função para o tipo tretramino
#;
...
(struct tetris (campo largura altura tetra proximos timeout nivel pt) #:transparent)
...
(define (make-tetris largura altura tetras timeout nivel pt)
